                                ...
                                <NavigationMenuLink asChild>
                                    ...
                                    >
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            Your ultimate business management tool
                                        </p>
                                    </Link>
                                </NavigationMenuLink>
                            </li>
                            <Item title="Business" href="/features/content-calendar" icon={<CalendarRangeIcon className="w-5 h-5" />}>
                                Plan and visualize your content strategy.
                            </Item>
                            <Item title="Communication" href="/features/hashtag-manager" icon={<HashIcon className="w-5 h-5" />}>
                                Research and track trending hashtags.
                            </Item>
                            <Item title="Analysis" href="/features/competitor-analysis" icon={<UsersIcon className="w-5 h-5" />}>
