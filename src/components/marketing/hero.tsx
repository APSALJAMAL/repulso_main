...
const Hero = () => {
    return (
        <div className="flex flex-col items-center text-center w-full max-w-5xl my-24 mx-auto z-40 relative">
            ...
            <BlurText
                word={"Your AI-powered environment\n for modern businesses"}
            ...
            <Container delay={0.1}>
                ...
                We’re an AI SaaS company building intelligent environments that empower business users with automated workflows, data-driven decisions, and scalable growth . <span className="hidden sm:inline">Repulso is the all-in-one solution for empowering businesses with intelligent AI ecosystems.</span>
                </p>
            </Container>
            <Container delay={0.2}>
                <div className="flex items-center justify-center md:gap-x-6 mt-8">
                    <Button asChild size="lg">
                    <a href="https://app.repulso.com" target="_blank" rel="noopener noreferrer">
                            Start for free
                        </a>
                    </Button>
