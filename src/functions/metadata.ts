...
export const generateMetadata = ({
    title = `${process.env.NEXT_PUBLIC_APP_NAME} - Empower your business with our AI Eco-systems`,
    ...
    noIndex = false,
    keywords = [
        "AI Eco-systems"," Artificial Intelligence Solutions", "Business Automation", "Smart AI Tools", "AI for Business", "AI Transformation", "Intelligent Systems", "AI Strategy", "Scalable AI", "Next-gen AI"
